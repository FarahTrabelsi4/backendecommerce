...
//afficher la liste des articles par une categorie
...
const page = req.query.page || 1;// Get the current page number from the queryparameters
...
const totarticles = await Article.countDocuments() // Get the total number of articles
//const totarticles = await Article.find({},null,{sort:{'__id':-1}}); // Get the total number of articlesou bien article.countDocuments()
const totalPages = Math.ceil(totarticles / limit); // Calculate the total number of pages
