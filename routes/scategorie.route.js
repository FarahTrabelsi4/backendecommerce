...
const SCategorie=require("../models/scategorie")/*determine l'emplacement du fichier */
...
res.status(404).json({ message: error.message });
 ...
 module.exports = router;/*il faut l'ajouter pour que l'imporattion dans app.js marche*/